...
import { applyChannel, bumpVersion, compareSemVer, formatSemVer, isValidSemVer, parseSemVer } from '../version'
...
describe('formatSemVer', () => {
	...
	it('formats with prerelease', () => {
		expect(formatSemVer({ major: 1, minor: 0, patch: 0, prerelease: 'beta.1' })).toBe('1.0.0-beta.1')
	})
})
